...
def auto_delete_school_on_change(sender, instance, **kwargs):
    try:
        ...
        school = None
    core_functions.handle_file_upload(instance, school, "image", "image/schools")
    core_functions.handle_file_upload(instance, school, "logo", "image/schools-logo")
...
def auto_delete_branch_on_change(sender, instance, **kwargs):
    try:
        ...
        branch = None
    core_functions.handle_file_upload(instance, branch, "image", "image/branches")